...
class ResultAnalyzer:
    ...
    def getGNUData(self, fname, header = None):
        ...
        graphs = []
        if self.ename.startswith("rwmicro") or self.ename.startswith("ehash") or self.ename.startswith("client_push") or self.ename.startswith('remote_client_push') or self.ename.startswith("breakdown"):
