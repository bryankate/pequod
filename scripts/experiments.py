...
cmdbase = "./obj/pqserver --client=7007 --twitternew --nusers=100000 --pactive=70 --postlimit=20000 --duration=100000000"
...
for m in modes:
    real_twitter.append({'plotgroup': "%s" % m[0],
                         ...
                         'cmd': "./obj/pqserver --client=7007 --rwmicro --nusers=100000 --pactive=70 --nfollower=110 --postlen=5 --popduration=500000 --prefresh=98 --nops=1000000 %s" % m[2]});
    real_twitter.append({'plotgroup': "%s" % m[0],
                         'plotkey' : "base",
                         'server' : "./obj/pqserver -kl=7007",
