...
#include <inttypes.h>
#include <arpa/inet.h>
#if HAVE_CXX_TEMPLATE_ALIAS && !(__clang__ && __APPLE__)
#include <type_traits>
#endif
...
/** @brief Default comparison function object.
    ...
    otherwise. Specialize this object rather than default_compare(). */
template <typename T>
...
/** @brief Default comparison.
    ...
    Returns negative if a < b, positive if b < a, and zero otherwise. */
template <typename T>
